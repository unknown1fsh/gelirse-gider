...
>(({ className, onImageSelect, preview, ...props }, ref) => {
  const [isDragOver, setIsDragOver] = React.useState(false)
  const [imagePreview, setImagePreview] = React.useState<string | null>(preview || null)
      ...
      >
        {imagePreview ? (
          ...
          <div className="flex flex-col items-center gap-2">
            <span>Resim seçin veya buraya sürükleyin</span>
