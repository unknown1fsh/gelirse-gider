...
>(({ className, onCodeSelect, accept = ".js,.ts,.jsx,.tsx,.py,.java,.cpp,.c,.cs,.php,.rb,.go,.rs,.swift,.kt,.scala,.r,.m,.pl,.sh,.bash,.zsh,.fish,.ps1,.bat,.cmd", ...props }, ref) => {
      ...
      >
        <div className="flex flex-col items-center gap-2">
          ...
          <span className="text-xs text-muted-foreground/70">
            JS, TS, JSX, TSX, PY, JAVA, CPP, C, CS, PHP, RB, GO, RS, SWIFT, KT, SCALA, R, M, PL, SH, BASH, ZSH, FISH, PS1, BAT, CMD formatları desteklenir
          </span>
        </div>
      </div>
    </div>
