      ...
      <div className="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
          ...
          <Link href="/transactions/new-income">
            <Card className="hover:shadow-md transition-shadow cursor-pointer border-green-200 hover:border-green-400">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-green-50">
                <CardTitle className="text-lg font-semibold text-green-700">Gelir Ekle</CardTitle>
          ...
          <Link href="/transactions/new-expense">
            <Card className="hover:shadow-md transition-shadow cursor-pointer border-red-200 hover:border-red-400">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 bg-red-50">
                <CardTitle className="text-lg font-semibold text-red-700">Gider Ekle</CardTitle>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>En son eklenen işlemlerin listesi</CardDescription>
          </CardHeader>
          <CardContent>
            {loading ? (
                        ...
                        <div className="flex items-center gap-3 mb-2">
                          <div
                            className={`w-3 h-3 rounded-full ${
                              transaction.txType.code === 'GELIR' ? 'bg-green-500' : 'bg-red-500'
                            }`}
                          />
                      ...
                      <div className="text-right">
                        <p
                          className={`text-lg font-bold ${
                            transaction.txType.code === 'GELIR' ? 'text-green-600' : 'text-red-600'
                          }`}
                        >
                          {transaction.txType.code === 'GELIR' ? '+' : '-'}
                          {formatCurrency(
