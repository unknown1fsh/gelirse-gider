...
export async function GET(request: NextRequest) {
  try {
    ...
    if (currentPlan === 'free') {
      return NextResponse.json(
        { 
          error: 'Gelişmiş trend analizi Premium üyelik gerektirir. Premium plana geçerek detaylı trend analizlerine erişebilirsiniz.',
    ...
    for (let i = 11; i >= 0; i--) {
      ...
      const prevMonthTransactions = transactions.filter(t => 
        t.transactionDate >= prevMonthDate && t.transactionDate <= prevMonthEnd
      )
      ...
      trendAlerts: [
        {
          ...
          description: 'Eğlence kategorisinde %18 artış tespit edildi. Bu trend devam ederse bütçe aşımı riski var.',
        ...
        },
        {
          ...
          description: 'Son 3 ayda gelir trendiniz %12 büyüyor. Bu momentumu korumak için yeni gelir kaynakları araştırın.',
